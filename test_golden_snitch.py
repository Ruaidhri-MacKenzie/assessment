...
print(f"1. golden_snitch.x initialises correctly: {test1}")

test2 = "Pass" if golden_snitch.y == y else "Fail"
print(f"2. golden_snitch.y initialises correctly: {test2}")
...
print(f"3. Return random direction within a single move: {test3}")
